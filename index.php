    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i = 0; $i < count($work); $i++): ?>
            <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $work[$i]['name']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work[$i]['dateStart']?> - <span class="w3-tag w3-teal w3-round"><?php echo $work[$i]['dateFinish']?></span></h6>
            <p><?php echo $work[$i]['description']?></p>
            <hr>
            </div>
        <?php endfor;?>
      </div>
